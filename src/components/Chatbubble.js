...
function ChatBubble() {
  ...
  return (
    <div className="max-w-sm p-6 bg-white text-black border border-gray-200  shadow dark:bg-black dark:text-white dark:border-gray-700  w-full sm:w-[375px] rounded-xl absolute sm:right-6 md:bottom-20 bottom-0  py-6 px-5">
